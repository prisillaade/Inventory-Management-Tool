...
<!--	Main Dashboard -->
		<div class= 'container'> 
			<section id = 'first'>
				<br>
				<h1 style="color:#8A1010;font-size:25px; text-align:center; "><b>Reservation</b></h1>
				<h3 style="color:#8A1010; font-size:15px; text-align:center;"> <i>Welcome to the administrator interface! <br> Here is the reservation management.</i></h3><br>
  			...
  			<section id= 'second'>
				...
				echo "<td><a href = \"editRes.php?id=".$row['_rID']."\"> <button class='editbtn' type= 'submit' style='background-color: #8A1010 ; border: none; color: white;'> edit </button></a></td>";
				echo "</tr>";
				}
  			...
  			<div class="order">
  				...
  				<br>
  					<a href="exportReservation.php"><button class = "btn btn-primary" id="order-now" type="submit" name="order" value="Reservation" style="background-color: #8A1010 ;"> Export as .xlsx</button></a>
